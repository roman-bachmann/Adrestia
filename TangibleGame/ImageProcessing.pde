...
class ImageProcessing extends PApplet {
  ...
  private PVector rotations;
  private PGraphics pg;

  public ImageProcessing(PImage image, PGraphics pg) {
    img = image.get();
    // TODO: Bug
    println(brightness(img.pixels[0]));
  ...
  void drawQuads(List<int[]> quads, ArrayList<PVector> lines) {
    for (int[] quad : quads) {
      ...
      pg.fill(255, 128, 0);
      pg.ellipse(c12.x, c12.y, 10, 10);
      pg.ellipse(c23.x, c23.y, 10, 10);
      pg.ellipse(c34.x, c34.y, 10, 10);
      pg.ellipse(c41.x, c41.y, 10, 10);
      
      // Draws the edges of the quad
      pg.stroke(204,102,0);
      pg.line(c12.x, c12.y, c23.x, c23.y);
      pg.line(c23.x, c23.y, c34.x, c34.y);
      pg.line(c34.x, c34.y, c41.x, c41.y);
      pg.line(c41.x, c41.y, c12.x, c12.y);
